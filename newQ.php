...
$currentSection = "PRACTICE WORKFLOW";
if(isset($_GET['s'])){	
...
<form method=post class='addQuestion'>
	<fieldset class='selectSection'>
		...
		<select id='lstQuestionSection' name='optSection'>
			<?php
...
document.getElementById("lstQuestionSection").addEventListener("change", function(){
var listBox=document.getElementById("lstQuestionSection").value;
if(listBox =="other"){
    document.getElementById("otherSection").style.visibility = "visible";
}else{
    document.getElementById("otherSection").style.visibility = "hidden";
}
});
</script>
