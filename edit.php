...
<form method=post class='editQuestion'>
	...
	<fieldset class='newChoices'>
		...
		<?php
			...
			echo "<div class='inputStyle'><input type='radio' class='styleRadio' disabled><input type='text' name='txtChoiceOne' value='" . $choiceOne . "'></div>";
			echo "<div class='inputStyle'><input type='radio' class='styleRadio' disabled><input type='text' name='txtChoiceTwo' value='" . $choiceTwo . "'></div>";
			echo "<div class='inputStyle'><input type='radio' class='styleRadio' disabled><input type='text' name='txtChoiceThree' value='" . $choiceThree . "'></div>";
			echo "<div class='inputStyle'><input type='radio' class='styleRadio' disabled><input type='text' name='txtChoiceFour' value='" . $choiceFour . "'></div>";
			echo "<div class='inputStyle'><input type='radio' class='styleRadio' disabled><input type='text' name='txtChoiceFive' value='" . $choiceFive . "'></div>";
		?>
	</fieldset>
